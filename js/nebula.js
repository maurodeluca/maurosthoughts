...
void main() {
    ...
    float pinkMask = ridge(w2, 0.03)*2.0 + ridge(w5,0.025)*1.5 + ridge(w6,0.028)*1.3;
    ...
    pinkMask = clamp(pinkMask*2.5, 0.0, 1.0);  // boost intensity
    nebCol += mix(salmon, pink, pinkMask) * pinkMask * 2.5;
    pinkMask *= fbm(ruv*10.0 + uTime*0.1, 2);
